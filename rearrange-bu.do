...
forvalues i=1/9 {
   ...
   if !_rc {
*      move qp0`i' usrace2_1
* New in 2016 *
      move qp0`i' se1_a
      capture confirm string var qp0`i'_text
*      if !_rc move qp0`i'_text usrace2_1
* New in 2016 *
      if !_rc move qp0`i'_text se1_a
   }
   forvalues j=1/50 {
      capture confirm numeric var qp0`i'_`j'
      if _rc continue, break
*      move qp0`i'_`j' usrace2_1
* New in 2016 *
      move qp0`i'_`j' se1_a
      capture confirm string var qp0`i'_`j'_text
*      if !_rc move qp0`i'_`j'_text usrace2_1
* New in 2016 *
      if !_rc move qp0`i'_`j'_text se1_a
   }
   forvalues k=97/99 {
      local a = char(`k')
      capture confirm numeric var qp0`i'`a'
      if !_rc {
*         move qp0`i'`a' usrace2_1
* New in 2016 *
         move qp0`i'`a' se1_a
         capture confirm string var qp0`i'`a'_text
*         if !_rc move qp0`i'`a'_text usrace2_1
* New in 2016 *
         if !_rc move qp0`i'`a'_text se1_a
      }
      forvalues j=1/15 {
         capture confirm numeric var qp0`i'`a'_`j'
         if _rc continue, break
*         move qp0`i'`a'_`j' usrace2_1
* New in 2016 *
         move qp0`i'`a'_`j' se1_a
         capture confirm string var qp0`i'`a'_`j'_text
*         if !_rc move qp0`i'`a'_`j'_text usrace2_1
* New in 2016 *
         if !_rc move qp0`i'`a'_`j'_text se1_a
      }
   }
}
move qp03_47 qp03_4
...
foreach o in a b {
   forvalues j=1/29 {
      capture confirm string var q50f`o'_`j'
      if !_rc move q50f`o'_`j' q40`o'
   }
   forvalues j=1/29 {
      capture confirm numeric var q50fd`o'_`j'
      if !_rc move q50fd`o'_`j' q40`o'
   }
   forvalues j=1/29 {
      capture confirm string var q50b`o'_`j'
      if !_rc move q50b`o'_`j' q40`o'
   }
   forvalues j=1/29 {
      capture confirm numeric var q50bd`o'_`j'
      if !_rc move q50bd`o'_`j' q40`o'
   }
}
