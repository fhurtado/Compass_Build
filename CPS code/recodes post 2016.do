...
// 11/16/19 Maximum age is 73 in 2019 so adult max age=73
***
#delimit ;
...
* adult3 if want to capture size of 13-70 
capture label drop ADULT3;
capture drop adult3;
recode prtage (min/12=0 "0 - 12")
              (13/17=1  "13 - 17")
              (18/70=2  "18 - 70")
              (71/max=3 "71 +"),
           gen(adult3) label(ADULT3);
vlabel adult3 "Age group";
...
capture label drop KIDS2;
capture drop kids2;
recode prnmchld (-1=0) (3/99=3 "3 +"), gen(kids2) label(KIDS2);
vlabel kids2, from(prnmchld);
...
* New in 2019;
gen hisp = pehspnon==1 & ( prcitshp<5 | (prcitshp==5 & 12<prtage & prtage<36) );
